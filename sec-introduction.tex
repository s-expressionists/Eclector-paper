...
\item[Parsing an editor buffer] As a concrete example of this
  ...
  notify them about the syntactic errors\footnote{Examples of
    ...
    \mintinline[escapeinside=||]{lisp}{cl:::nth}, a digit using an
    invalid radix in \mintinline[escapeinside=||]{lisp}{|\#|b0102} and
    a missing closing parenthesis at the end of the program.},
  semantic errors\footnote{Only one branch of the nested read-time
    conditional \mintinline[escapeinside=||]{lisp}{|\#|+sbcl |\#|b0102
      |\#|-sbcl |\#|b0100} is reachable.}  and style
